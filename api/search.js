export default async function handler(req, res) {
  ...
  try {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      console.log("round", i, "stop_reason:", data.stop_reason, "content types:", (data.content||[]).map(b=>b.type));
    ...
    console.log("final text length:", finalText.length, "preview:", finalText.slice(0, 200));
